...
/** Displays locked bet terms without exposing either partner's wheel items. */
    ...
    <article className={`bet-card bet-card--${bet.status}`}>
      ...
      {bet.status === 'active' ? (
        <div className="bet-lock-summary">
          ...
          <span>
            The wager and both private wheel pools are locked. Wheel contents
            remain hidden until settlement reveals one result.
          </span>
        </div>
      ) : null}
